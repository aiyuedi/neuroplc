...
\end{tabular}
\vspace{2pt}
{\scriptsize $^{*}$Corr\^ea~\cite{correa2024kanplc}：PC侧KAN推理，PLC通过Snap7以太网接收结果——无原生SCL编译。KANEL\'{E}~\cite{kanele2026}、LUT-KAN~\cite{lutkan2025}、KAN-SoC~\cite{kan_soc_2025}。}
\end{table*}
