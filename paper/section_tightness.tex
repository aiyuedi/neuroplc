...
Corollary~\ref{cor:da-optimality} established that DA's coefficients are
...
\texttt{code/theory/\allowbreak{}da\_tightness\_\allowbreak{}proof.m}).\par\endgroup
...
\vspace{4pt}
\noindent\textbf{Combined consequence of
Corollary~\ref{cor:da-optimality} and~\ref{thm:tightness}.}
Corollary~\ref{cor:da-optimality} proves DA's \textit{coefficient Pareto-optimality}
...
Figure~\ref{fig:da_tightness} verifies the attainment numerically.

\vspace{4pt}
\begin{figure}[t]
    \centering
    \includegraphics[width=0.85\linewidth]{figures/final/fig03_da_tightness}
