...
(\texttt{optimizer.py::adaptive\_bspline\_sampling}) used the density
...
(\texttt{verify\_optimal\_lut.py}, E-T1: cross-function $2.75\times$,
within-function $3.32\times$ improvement; results in
\texttt{results/theory/ti\_optimal\_lut.json}). This converts the
