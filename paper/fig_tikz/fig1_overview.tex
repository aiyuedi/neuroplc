...
\node[keymetric=purple] at ({3*\dx},-1.85) {DA margin 1.0$\times$};
% FIXME(2026-08-03): fig1_overview must be regenerated with the recomputed
% DA safety factor (1.0x at the M2_char calibration) before submission.
