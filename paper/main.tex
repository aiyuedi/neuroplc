...
$196\times$ via soft-contractive training, E-T9).
...
and soft-contractive training (E-T9) to $196\times$ with full
...
and soft-contractive training (E-T9) to $196\times$.
...
Soft-contractive DA (E-T9) & 15 & DA, $\gamma{=}[1.03,1.38]$ model & 0.0034 & $196\times$ \\
Soft-contractive IA (E-T9) & 15 & IA, $\gamma{=}[1.03,1.38]$ model & 0.0049 & $138\times$ \\
...
\textbf{Soft-contractive rows} (0.0034/0.0049): E-T9 checkpoint
($\gamma = [1.03, 1.38]$, 98.5\% acc); constants measured on that
checkpoint, 2026-08-04 (\texttt{verify\_contractive\_bounds.py}).
At the $M_2^{\max}$ calibration the same rows read 0.0086/0.0122
(safety $78\times$/$55\times$).}
\end{table}
...
E-T9 & Soft-Contractive Training & $\gamma$ post-training & $[1.03,1.38]$; 98.5\%; DA cert.\ $196\times$ \\
\midrule
...
Soft-contractive & DA+IA & 15 & $196\times$ & SIL~3+ & E-T9 checkpoint
