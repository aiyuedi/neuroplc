...
verify layer-wise contractivity $P(\text{KAN})\leq 1$ empirically for the trained
model (Condition~3, {\S}\ref{sec:svnn-conditions}), noting that
...
$\Delta \leq 0.71$ (consistent with Lemma~6) and the
...
depth-uniform bound and Theorem~4's depth-scaling analysis. The 3-layer
