...
Z3-verified components, and depth extension to $L=3$ ($4.4\times$);
...
Soft-contractive worst (E-T9) & 15 & IA-form, $M_2^{\max}$ & 0.039 & $17.5\times$ \\
Soft-contractive sound (E-T9) & 15 & no-cancell., floored & 0.058 & $11.6\times$ \\
...
envelopes 1.70/7.78 (safety $0.4\times$/$0.1\times$)---the design-time
certificate does not exist for this checkpoint, and its measured maxAE
($0.52$) is a lucky $15\times$ below the worst envelope.
...
(0.039) is the no-cancellation IA form at full-$\varphi$ $M_2^{\max}$
(1.39); the \textbf{sound row} (0.058) adds the measured floor (maxAE
$0.053$, 13{,}714 inputs, Tier-4 simulator). Released student: worst
envelope $7.78$ (safety $0.1\times$, not a certificate), expected
$1.70$ ($0.4\times$).}
\end{table}
...
E56& Deep KAN ($L{=}3$)       & [28,16,8,4] 120ep & \textbf{99.60\%}, 608/608 Z3, DA 5.66, sub-exp. depth; E-T9-3L: \textbf{98.6\%}, sound cert.\ $4.4\times$ \\
...
\begin{itemize}
    ...
    \item \textbf{DA error bound:} the 3-layer DA chain measures
          ...
          \emph{sound} certificate of $0.154$ (safety $4.4\times$;
          no-cancellation IA form at full-$\varphi$ $M_2^{\max}$,
          covering the measured maxAE $0.10$)---depth scaling
...
extension to $L{=}3$ ($4.4\times$); adaptive allocation (E15) achieves
