...
\begin{enumerate}[label=(\roman*)]
    ...
    100~ms cycle with $N$ at $22.67$~ms, $77.33$~ms remain for $P$'s
    ...
    here with $\text{WCET}(N) = 22.67$~ms $< 100$~ms scan cycle,
    leaving $77.33$~ms for $P$'s POUs and the OS scheduler. If the
