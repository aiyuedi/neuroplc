...
\emph{(iii) sharp rate forces optimal allocation:} any certificate
achieving the minimax rate must implement the T-I optimal allocation
(Theorem~\ref{thm:optimal_lut}), since the deviation gap of any other
allocation is explicit and positive.
Hence, in $\mathcal{C}$, $(P1)+(P2)$ imply SVNN Conditions~1--2---the
first lattice of the trichotomy necessity---while Condition~3
(contractivity) is \emph{not} necessary (Theorem~\ref{thm:compile_aware_minimax}
holds for $\gamma \geq 1$).
\end{theorem}
