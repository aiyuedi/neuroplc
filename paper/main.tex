...
Soft-contractive float64 (E-T9) & 15 & per-$\varphi$ propag., floored & 0.026 & $26\times$ \\
...
envelopes 1.70/3.38 (safety $0.4\times$/$0.2\times$)---the design-time
certificate does not exist for this checkpoint, and its measured maxAE
($0.52$) is a lucky $6.5\times$ below the per-function envelope.
...
per-function envelope $3.38$ (safety $0.2\times$, not a certificate),
