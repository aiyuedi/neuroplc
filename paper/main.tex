...
SVNN Cond.~3 (per-layer $\gamma<1$) is a \emph{training} property, not a pipeline property: unsatisfied by the released checkpoint and by E-T10/E-T11 (second-layer $\gamma>1$); MNIST (E42) and ChebyKAN (E54) were not measured. This table documents \emph{pipeline} generality (compiler/verification domain-independence); contraction is established by the soft-contractive recipe (E-T9--E-T11).}
\end{table*}
