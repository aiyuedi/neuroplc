...
certified safety state across model updates. Four $C^2$-BV architectures
...
E56& Deep KAN ($L{=}3$)       & [28,16,8,4] 120ep & \textbf{99.60\%}, 608/608 Z3, DA 5.66, sub-exp. depth \\
...
\begin{enumerate}[label=\arabic*.]
   ...
   stated as a conjecture with strong evidence; establishing it
   formally (formalizing ``design-time-computable'' as a complexity
   class) is an open problem that the regime exclusions of the theorem
   delimit.
