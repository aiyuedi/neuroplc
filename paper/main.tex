...
theory as the first self-verifying PyTorch-to-IEC~61131-3 compiler,
...
block in load memory). This is the first runtime-update protocol for
...
(1)~\textbf{type-theoretic foundation}---17 theorems providing the first formal
...
\begin{enumerate}[label=\arabic*.]
   ...
   connection $(\alpha, \gamma)$, making the framework the first neural
