...
\midrule
 ...
 Safety margin & 5.6$\times^{\P\P}$ & 1.0$\times^{**}$ & 13.7$\times^{\P\P\P}$ & 1.1$\times$ & \textbf{4.9$\times^{\S\S}$} & \textbf{2.8$\times^{\S\S}$} \\
...
$^{\S\S}$E-T10/E-T11 certificates: FourierKAN validated floor bound 0.138 (N=15 full-LUT; first-principles 0.110 does not cover the full-set measured 0.126, which includes 2.7\% out-of-domain inputs); FourierKAN L0-direct configuration sound 0.130 (N=16 L1 LUT, Box 100\%, covers measured 0.091; 2026-08-05); WaveletKAN first-principles sound 0.237 (covers measured 0.157).
