...
\begin{figure*}[t]
    ...
    line marks the illustrative contractive case $\gamma = 0.182$, shown for
    contrast against the trained student's measured per-layer amplification
    $\gamma = [15.4, 5.3] > 1$ (E68).
    Right: per-layer amplification ratio $R(d) = \sqrt{d} / \gamma$ for widths
    $d$ from 4 to 256 (the construction is sharp for any fixed $\gamma$).
