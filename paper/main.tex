...
E56& Deep KAN ($L{=}3$)       & [28,16,8,4] 120ep & \textbf{99.60\%}, 608/608 Z3, DA 5.66, sub-exp. depth; E-T9-3L: \textbf{98.6\%}, validated cert.\ $6.1\times$ \\
...
\begin{itemize}
    ...
    \item \textbf{DA error bound:} the 3-layer DA chain measures
          ...
          \emph{sound} certificate of $0.110$ (safety $6.1\times$;
          float32 measured floor; per-function float64 bound $0.019$,
          safety $36\times$)---depth scaling
