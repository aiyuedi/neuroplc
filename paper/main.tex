...
Theorem~\ref{thm:wcet} (22.67~ms), which additionally accounts for
...
\begin{enumerate}[label=(\roman*)]
   ...
   estimate, not a formal guarantee; it corroborates the Z3 kernel WCET.
    ...
    \item \textbf{Conservative WCET Upper Bound (Theorem~11): $22.67$~ms.}
...
Theorem~\ref{thm:wcet} (22.67~ms) remains the deployment-relevant
