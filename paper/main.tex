...
to a first-principles \emph{sound} certificate of $2.34\times$ (pure
...
adaptive allocation, {\S}\ref{sec:adaptive-lut}, or to $2.34\times$
...
and soft-contractive training (E-T9) to $2.34\times$ (first-principles
...
and soft-contractive training (E-T9) to $2.34\times$ (sound) /
$11.6\times$ (validated).
...
numbers (0.288/2.34$\times$; WaveletKAN 0.237 first-principles covers
...
expected tier $493\times$; sound tier $2.34\times$ \\
...
($1.0\times$, expected) to sound ($2.34\times$, first-principles) with a
