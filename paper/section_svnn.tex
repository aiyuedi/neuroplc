...
the end-to-end ratio, so the observed $2.2\times$ advantage tracks the
...
The $2.2\times$ end-to-end tightening (E9) is close to the per-segment
...
$5.6\times$ (IA, E9) to $17.0\times$ (DA, E9)---a 3.1$\times$ margin
