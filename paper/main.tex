...
\begin{enumerate}[label=(\roman*)]
    ...
    exact). Any tighter coefficient violates soundness on $62.4\%$ of
...
\end{tabular}
\vspace{1pt}
{\scriptsize NeuroPLC provides the only design-time correctness guarantee (18 theorems),
...
\end{tabular}
\vspace{2pt}
{\scriptsize NeuroPLC is the only platform providing: formal certification (18 theorems),
...
(1)~\textbf{type-theoretic foundation}---18 theorems providing the first formal
