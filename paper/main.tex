...
Soft-contractive worst (E-T9) & 15 & per-$\varphi$ propag., $M_2^{\max}$ & 0.0078 & $87\times$ \\
...
(0.0078) is the per-function no-cancellation propagation at full-
$\varphi$ $M_2$ (float64, safety $87\times$); the \textbf{sound row}
