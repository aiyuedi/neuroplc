...
(Tier~4 differential test: 100\% agreement, max logit error 0.24, E67),
...
E67& Tier-4 Differential Test  & PyTorch vs SCL-sim (emitter) & 3{,}000 samples 100\% agree; maxAE 0.24; \textbf{caught scale regression} \\
...
\begin{enumerate}
    ...
    \item \textbf{Tier~4---Differential Self-Test (Every Compilation):}
         ...
         samples, 100\% agreement, max logit error 0.24 (E67).
\end{enumerate}
