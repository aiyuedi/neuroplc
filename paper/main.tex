...
+ V1--V7) plus nine capacity-theory verification experiments
(E-T1--E-T9, {\S}\ref{sec:capacity}) spanning compression,
...
\midrule
\multicolumn{4}{l}{\textit{Capacity-Theory Verification (E-T1--E-T9):}} \\
...
\vspace{4pt}
\noindent\textbf{Empirical validation (74 experiments + 9 capacity
experiments E-T1--E-T9, 4 architectures).}
