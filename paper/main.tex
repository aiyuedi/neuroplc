...
zero slack; the completeness of this boundary is the trichotomy
...
\begin{enumerate}[label=(\roman*)]
    ...
    slack) simultaneously (completeness of this boundary is the
...
\begin{enumerate}
    ...
    \item \textbf{Theory (Completeness):} Beyond sufficiency, we establish
         ...
         completeness of the boundary is the trichotomy necessity
         conjecture).
...
\begin{enumerate}[label=\arabic*.]
   ...
   SVNN uniquely attains (polynomial time, zero slack) (completeness
   of this boundary is the trichotomy necessity conjecture).
