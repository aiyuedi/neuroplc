...
% TODO: the per-function threshold used in the E58 experiment (0.182) was
% the stale contractivity constant, not a measured margin; the margin
% ratios quoted in earlier versions (4.5x, 6.0x at P95) derived from it
% and must be re-established against a properly measured per-function
...
\begin{figure*}[t]
    ...
    % TODO: the margin ratios shown in this figure used the stale
    % contractivity constant 0.182 as the per-function threshold; the
    % figure must be regenerated with an honestly measured margin before
    % submission.
